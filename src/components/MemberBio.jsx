...
export function MemberBio({ imgSrc, onOpenMoreInfo, memberName = 'Omid' }) {
  return (
    <div className='grid grid-cols-12 border-2 rounded-3xl over p-2 text-sm'>
      <div className='col-span-4 max-h-full sm:col-span-2 md:col-span-5 flex items-center justify-center rounded-full overflow-hidden border-2 border-pink self-center justify-self-center'>
        <img className='' src={imgSrc} alt={`${memberName} image`} />
      </div>

      <div className='col-span-8 sm:col-span-10 md:col-span-7 pl-4 flex flex-col justify-between'>
