...
export function MemberBio({ imgSrc, memberName= 'Omid' }) {
  return (
    <div className='grid grid-cols-3 border-2  rounded-3xl over p-2 text-sm'>
      ...
      <div className='col-span-2 pl-4 flex flex-col justify-between'>
        <h3 className="border-l-2 border-yellow bg-gray p-1 rounded-se-2xl">{memberName}</h3>
        ...
        <div className="flex justify-between h-8">
          <button className="bg-yellow text-blue px-5 rounded-lg">more info</button>
